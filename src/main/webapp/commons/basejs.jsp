    ...
    <!-- [EasyUI] -->
    <link id="easyuiTheme" rel="stylesheet" type="text/css" href="${staticPath }/plugins/easyui/themes/gray/easyui.css" />
    <link id="easyuiTheme" rel="stylesheet" type="text/css" href="${staticPath }/plugins/easyui/themes/icon.css" />
    ...
    <!-- [扩展样式] -->
    <link rel="stylesheet" type="text/css" href="${staticPath }/static/css/dreamlu.css" />
    <link rel="stylesheet" type="text/css" href="${staticPath }/static/css/icommon.css" />
