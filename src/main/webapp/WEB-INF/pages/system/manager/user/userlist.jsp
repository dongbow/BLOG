...
<script type="text/javascript">
    ...
    $(function() {
        ...
        dataGrid = $('#dataGrid').datagrid({
            url : '${path}/system/admin/user/dataGrid',
            fit : true,
            striped : true,
            rownumbers : true,
            pagination : true,
    ...
    function addFun() {
        parent.$.modalDialog({
            ...
            width : 356,
            height : 402,
            href : '${path }/system/admin/user/addPage',
            buttons : [ {
                text : '添加',
                handler : function() {
                    parent.$.modalDialog.openner_dataGrid = dataGrid;//因为添加成功之后，需要刷新这个dataGrid，所以先预定义好
                    var f = parent.$.modalDialog.handler.find('#addUserAction');
                    f.submit();
                }
            } ]
        });
    ...
    function exportFun() {
    	 parent.$.modalDialog({
             ...
             width : 600,
             height : 440,
             href : '${path }/system/admin/user/exportPage',
             buttons : [ {
                 text : '导出为Excel',
                 handler : function() {
                     var f = parent.$.modalDialog.handler.find('#userEditForm');
        ...
        <form id="searchForm">
            <table>
                <tr>
                    ...
                    <th>用户ID:</th>
                    <td><input name="uid" class="easyui-textbox" data-options="prompt:'输入用户ID'" style="width:80px;"/></td>
                    <th>登录名:</th>
                    <td><input name="username" placeholder="请输入用户登录名"/></td>
                    <th>昵称:</th>
