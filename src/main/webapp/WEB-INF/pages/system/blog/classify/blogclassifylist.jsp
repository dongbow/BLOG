...
$(function() {
    ...
    dataGrid = $('#dataGrid').datagrid({
        url : '${path}/system/admin/blogclassify/dataGrid',
        fit : true,
        striped : true,
        rownumbers : true,
        pagination : true,
    ...
    function addFun() {
        parent.$.modalDialog({
            ...
            width : 348,
            height : 223,
            href : '${path }/system/admin/classify/addClassifyPage',
            buttons : [ {
                text : '添加',
                handler : function() {
                    parent.$.modalDialog.openner_dataGrid = dataGrid;//因为添加成功之后，需要刷新这个dataGrid，所以先预定义好
                    var f = parent.$.modalDialog.handler.find('#addClassify');
                    f.submit();
                }
            } ]
        });
    ...
    <div data-options="region:'north',border:false" style="height: 30px; overflow: hidden;background-color: #fff">
        <form id="searchForm">
            <table>
                <tr>
                    <th>分类名:</th>
                    <td><input name="name" placeholder="请输入分类名"/></td>
                    <th>状态:</th>
                    <td>
