...
<script type="text/javascript">
    ...
    $(function() {
        ...
        dataGrid = $('#dataGrid').datagrid({
            url : '${path}/system/admin/blog/replyDataGrid',
            fit : true,
            striped : true,
            rownumbers : true,
            pagination : true,
...
<body class="easyui-layout" data-options="fit:true,border:false">
    <div data-options="region:'north',border:false" style="height: 30px; overflow: hidden;background-color: #fff">
        <style>
        	#searchForm input { width: 95px;}
        </style>
        <form id="searchForm">
            <table>
                <tr>
                    <th>ID:</th>
                    <td><input name="bg_rid" placeholder="请输入ID" width="60"/></td>
                    <th>内容:</th>
                    <td><input name="content" placeholder="请输入关键字"/></td>
                    <th>博客ID:</th>
                    <td><input name="blog_id" placeholder="请输入博客ID"/></td>
                    <th>状态:</th>
                    <td>
