...
<script type="text/javascript">
    ...
    $(function() {
        ...
        dataGrid = $('#dataGrid').datagrid({
            url : '${path}/system/admin/mood/dataGrid',
            fit : true,
            striped : true,
            rownumbers : true,
            pagination : true,
    ...
    function addFun() {
        parent.$.modalDialog({
            ...
            width : 800,
            height : 500,
            href : '${path }/system/admin/mood/addMoodPage',
            buttons : [ {
                text : '发表',
                handler : function() {
                    parent.$.modalDialog.openner_dataGrid = dataGrid;//因为添加成功之后，需要刷新这个dataGrid，所以先预定义好
                    var f = parent.$.modalDialog.handler.find('#addMoodAction');
                    f.submit();
                }
            } ]
        });
...
<body class="easyui-layout" data-options="fit:true,border:false">
    ...
    <div data-options="region:'center',border:true,title:'心情列表'" >
        <table id="dataGrid" data-options="fit:true,border:false"></table>
    </div>
    <div id="toolbar" style="display:block;">
        <a onclick="addFun();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add'">写心情</a>
